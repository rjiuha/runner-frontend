...
export function getRunnerAnimationImage(type, status, anim, colorKey) {
    ...
    // (2026-09-12/13, см. lib/board#pickDeathVariant) — САМА ПО СЕБЕ служит
    // финальной позой (по прямому решению пользователя отдельная 'destroyed'
    // после неё не нужна). Ассетов под
